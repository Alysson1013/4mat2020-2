...
controller.listar = async (req, res) => {
    try {
        ...
        //populate() traz os arquivos completos referentes aos dados do BD, não só com o id, como é o padrão
        let dados = await Turma.find()
            .populate('curso')//retorna todos os dados do curso
            .populate('professor', 'nome email')//retorna apenas nome e email
            .populate('sala_aula')
        res.send(dados)
    }
    catch (erro) {
...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Turma.findById(id) //Capturando o parametro id
